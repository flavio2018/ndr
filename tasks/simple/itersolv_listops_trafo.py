...
def a(parser: framework.helpers.ArgumentParser):
    ...
    parser.add_argument("-itersolv_listops.iid_num_operands", default=2)
...
@task()
class ItersolvArithmeticTrafo(IterSolvListopsMixin, TransformerClassifierMixin, SimpleTask):
    pass